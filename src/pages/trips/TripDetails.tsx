...
import { MapPin, Calendar, Weight, DollarSign, User, Info, MessageCircle } from 'lucide-react';
  ...
  const handleBookTrip = async () => {
    ...
    try {
      ...
      if (luggageSize > trip.availableSpace) {
        setBookingError(`The traveler only has ${trip.availableSpace}kg of space available`);
        return;
      }
    ...
    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-start mb-6">
                ...
                <div className="ml-4">
                  <h2 className="text-lg font-medium text-gray-900">{trip.travellerName}</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-2">
                      ...
                      <p className="text-base font-medium text-gray-900">{trip.departureLocation}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-2">
                      ...
                      <p className="text-base font-medium text-gray-900">{trip.availableSpace} kg</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-6 mt-6 border-t border-gray-200">
                <h3 className="mb-4 text-lg font-medium text-gray-900">Important Information</h3>
                <div className="p-4 rounded-md bg-blue-50">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h4 className="text-sm font-medium text-blue-800">For Senders</h4>
                      <div className="mt-2 space-y-1 text-sm text-blue-700">
                        <p>• Contact the traveler after booking to arrange pickup and delivery details.</p>
                        <p>• Ensure your items comply with airline regulations and customs requirements.</p>
                        <p>• Payment is held securely until the delivery is confirmed.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div>
          <Card>
            <CardHeader>
              <h2 className="text-xl font-bold text-gray-900">Book Luggage Space</h2>
            </CardHeader>
                ...
                <>
                  ...
                  {!isAuthenticated ? (
                    <div className="py-6 text-center">
                      <p className="mb-4 text-gray-600">You need to be logged in to book luggage space.</p>
                      <Link to="/login">
                    ...
                    <div className="py-6 text-center">
                      <p className="mb-4 text-gray-600">Only senders can book luggage space.</p>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input
                          type="number"
                          value={luggageSize}
                          onChange={(e) => setLuggageSize(parseFloat(e.target.value))}
                          min="0.1"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) => setLuggageDescription(e.target.value)}
                          rows={3}
                      ...
                      <div className="p-4 rounded-md bg-gray-50">
                        <h4 className="mb-2 text-sm font-medium text-gray-900">Price Summary</h4>
                        <div className="flex justify-between mb-1 text-sm text-gray-600">
                          <span>{luggageSize} kg × {trip.pricePerKg} {trip.currency}</span>
                          <span>{totalPrice} {trip.currency}</span>
                        </div>
                        <div className="flex justify-between mb-1 text-sm text-gray-600">
                          <span>Service Fee</span>
                          <span>{Math.round(totalPrice * 0.1)} {trip.currency}</span>
                        </div>
                        <div className="flex justify-between pt-2 my-2 font-medium border-t border-gray-200">
                          <span>Total</span>
                          <span>{Math.round(totalPrice * 1.1)} {trip.currency}</span>
                        </div>
                      </div>
              ...
              <div className="w-full">
                <div className="flex items-center justify-center">
                  ...
                  <span className="text-sm text-gray-600">
                    Questions? <a href="#" className="text-blue-600 hover:text-blue-500">Contact the traveler</a>
                  </span>
                </div>
              </div>
            </CardFooter>
