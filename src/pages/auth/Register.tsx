              ...
              <div className="mt-1 space-y-2">
                <div className="flex items-center">
                  <input
                    ...
                    {...registerField('role')}
                  />
                  <label htmlFor="role-sender" className="ml-3 block text-sm font-medium text-gray-700">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    {...registerField('role')}
                  />
                  <label htmlFor="role-traveller" className="ml-3 block text-sm font-medium text-gray-700">
