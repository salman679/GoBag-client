      ...
      <CardContent className="flex-grow">
        <div className="flex items-start justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-900">{trip.travellerName}</p>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-start">
            ...
            <div className="ml-2">
              ...
              <p className="text-sm font-medium text-gray-900">{trip.departureLocation}</p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-2">
              ...
              <p className="text-sm font-medium text-gray-900">{trip.availableSpace} kg</p>
            </div>
          </div>
